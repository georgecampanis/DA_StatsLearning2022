...
lst=c("nycflights13", "gapminder", "Lahman")
#--------------------
# coding basics
#--------------------
# Math
...
#sd(c(1,12,3,6,NULL,8), na.rm = FALSE)
...
mean(c(1,12,3,6,-10000000,8), trim = 0.175)
...
median(c(1,12,3,6,-10000000,8, 1000000000))
...
#other quantiles
quantile(dat$Sepal.Length, 0.01) # 1st percent
